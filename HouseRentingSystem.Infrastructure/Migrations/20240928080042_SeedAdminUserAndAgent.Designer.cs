...
namespace HouseRentingSystem.Infrastructure.Migrations
{
    ...
    [Migration("20240928080042_SeedAdminUserAndAgent")]
    partial class SeedAdminUserAndAgent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HouseRentingSystem.Infrastructure.Models.Agent", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("d038a75f-fcb7-475c-b36c-ab312ef170be"),
            ...
            modelBuilder.Entity("HouseRentingSystem.Infrastructure.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEFpL0R3tKFOyOl3a+e2SQHBwgFr71LEwBq7kxg/4RY8FFToTxdHpi7BURQsTVCRaWw==",
                        ...
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJf9gZDQpvNuXvyw7CYON5dmgMdpaPYjsC72qa2Fy8IJu8vDO4DvVT9lUXClylXouw==",
                            PhoneNumberConfirmed = false,
                        ...
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEKDLplCqADyddicHX8N1kM/cowmTFrDApLe8XEC6KYFF8t1oM6JalRwNEZVkUxbwZg==",
                            PhoneNumberConfirmed = false,
            ...
            modelBuilder.Entity("HouseRentingSystem.Infrastructure.Models.House", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bcebe4ef-0369-4799-8c3e-14078eb172e4"),
                            Address = "North London, UK (near the border)",
                            AgentId = new Guid("bae99276-1865-4c63-899c-093d3b85f014"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2024, 9, 28, 11, 0, 41, 280, DateTimeKind.Local).AddTicks(6224),
                            ...
                            UpdatedOn = new DateTime(2024, 9, 28, 11, 0, 41, 280, DateTimeKind.Local).AddTicks(6310)
                        },
                        new
                        {
                            Id = new Guid("88827f13-3e7c-455e-b843-9acd9d2fae7b"),
                            Address = "Near the Sea Garden in Burgas, Bulgaria",
                            AgentId = new Guid("bae99276-1865-4c63-899c-093d3b85f014"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2024, 9, 28, 11, 0, 41, 280, DateTimeKind.Local).AddTicks(6412),
                            Description = "It has the best comfort you will ever ask for. With two bedrooms, it is great for your family.",
                            ImageUrl = "https://cf.bstatic.com/xdata/images/hotel/max1024x768/179489660.jpg?k=2029f6d9589b49c95dcc9503a265e292c2cdfcb5277487a0050397c3f8dd545a&o=&hp=1",
                            IsActive = true,
                            PricePerMonth = 1200.00m,
                            Title = "Family House Comfort",
                            UpdatedOn = new DateTime(2024, 9, 28, 11, 0, 41, 280, DateTimeKind.Local).AddTicks(6414)
                        },
                        new
                        {
                            Id = new Guid("7a431113-eaa1-4508-800b-08176e7b217f"),
                            Address = "Boyana Neighbourhood, Sofia, Bulgaria",
                            AgentId = new Guid("bae99276-1865-4c63-899c-093d3b85f014"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2024, 9, 28, 11, 0, 41, 280, DateTimeKind.Local).AddTicks(6423),
                            Description = "This luxurious house is everything you will need. It is just excellent.",
                            ImageUrl = "https://i.pinimg.com/originals/a6/f5/85/a6f5850a77633c56e4e4ac4f867e3c00.jpg",
                            IsActive = true,
                            PricePerMonth = 2000.00m,
                            Title = "Grand House",
                            UpdatedOn = new DateTime(2024, 9, 28, 11, 0, 41, 280, DateTimeKind.Local).AddTicks(6430)
                        });
                });
